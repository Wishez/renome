"""
Django settings for renome project.
...
SECRET_KEY = 'ec(dejx4k(_($i@_u@e6@yuvd*o!a*f7^@hk#5xm96^ieyea=@'
...
WSGI_APPLICATION = 'renome.wsgi.application'
