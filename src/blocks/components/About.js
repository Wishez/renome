		...
		return (
			<section className='about'>
				...
				<AboutItem block='choice' 
					...
					text="Вы можете выбрать один из уже созданных нами <span class='choice__decorator--color_lightBrown'>шаблонов</span>
					для вашего проекта и откорректировать его под ваши желания,
					или представить что-то своё &mdash; уникальное." />
